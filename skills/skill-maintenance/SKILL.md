...
description: Maintain shared coding skills, routing and execution contracts when explicitly requested. Keep task history and application behavior out of reusable instructions.
---
